# Path to the PFX file and password
$pfxPath = "C:\Temp\Code Signing Cert.pfx"
$pfxPassword = ConvertTo-SecureString -String "Me4sur3d#" -AsPlainText -Force

# Import to Personal (My) store
Import-PfxCertificate -FilePath $pfxPath -Password $pfxPassword -CertStoreLocation Cert:\LocalMachine\My

# Import to Trusted Root Certification Authorities
Import-PfxCertificate -FilePath $pfxPath -Password $pfxPassword -CertStoreLocation Cert:\LocalMachine\Root

# SIG # Begin signature block
# MIIFeQYJKoZIhvcNAQcCoIIFajCCBWYCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU6DFJMW1Tze0RTnlnE1pCDYip
# /1agggMQMIIDDDCCAfSgAwIBAgIQN+o39s47b7xKGeApp7qR0DANBgkqhkiG9w0B
...
# CQQxFgQUTfkRdNi7YU99UpQUP6XsHV3V8O4wDQYJKoZIhvcNAQEBBQAEggEAFRnm
# 8adl2+ZwliBbbjcgm3huJo4WhIRNiJBLXrmWlUzpXyMubA0dV0ydKeldSvC2zQoO
# M4C3sNMbodN1jCajtMCYtj9xyYG22nrWcN7kP2caCyYx5THUBURx7FtgK0ajgLwo
# kjv6hsBxjzF+fqz9RdGqugfzMNFOU1ZiI1SabGslu9xsDtc+boyIDspOLWZDzYil
# W8U8FyIqmcGuR1JaTFPtIEjkqUR3rG5AQOMj8a6HKC8siDfqmBMoqAG9ptO6dhNu
# LB+LhLAy1p09GGWnaTQgcEniVRuhcbU8wTNK+V7RmjANt26rpIhUu4BOyaueumqO
# U0FM0GrJB8T/N5mnPQ==
