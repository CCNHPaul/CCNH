...
Script Name: Enable-BitLocker.ps1
Author: Paul Hanlon for Catholic Charities NH
Created: 12/26/2024
Description: Enables BitLocker on the specified drive with recovery password. Skips hardware test for faster deployment.
#>

# Enable BitLocker on the specified drive with the given settings
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU67BA+fvm6xCSgJEL4z6ViXNb
# 70ygggMQMIIDDDCCAfSgAwIBAgIQN+o39s47b7xKGeApp7qR0DANBgkqhkiG9w0B
...
# CQQxFgQUvlO1WugtRRZ/Cd2Mn6tZ2qPpErIwDQYJKoZIhvcNAQEBBQAEggEAY4zO
# rwFmoO0KHVZCH7/viELUU/Qa3HFB6xKyuRsDZy64A4cGcrfWzBnGrpcO8P5uC6MP
# SlePiSEG0r9OaGNwQerxm3ltF8Ob/H2RpHYTqGKw061C++Yx6f1KXODQnlp5ZZWM
# b02cc3CPWF/Ta+UZC8L3R3hH8RM7En5LACWWNLMwm2Ny1mxolPBKoHA9WOBoreeC
# dretSIP+ghu5lMzVYIc+1h/JW4cZ9f7X/oiO1nCUgJbp2dMmQyX0K8OXL0mNgVAi
# Bl89oGiL1o2mRqo7ZOEFHbIPT6vaWJe1AtOu0rIS66yCa91HwlwZrQ/j0sfJc0CI
# wCbebNSNqbFX9+n+yg==
