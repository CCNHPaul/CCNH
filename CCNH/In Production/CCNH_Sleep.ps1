...
Script Name: CCNH_Sleep.ps1
Author: Paul Hanlon for Catholic Charities NH
Created: 10/24/2023
Description: This PowerShell script automates the process of disabling hibernation and Sleep button.
Along with setting sleep to never plugged in and on battery
#>
...
# Set HDD Timeout to 0 seconds (disabled) on Battery and Plugged in
...
# Set LID Timeout to 0 Seconds on Battery and Plugged in
...
# Set Power Button to Shutdown on Battery and Plugged in
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUdWjMgKAqy4dvB7yVo2HXRFhL
# yJqgggMQMIIDDDCCAfSgAwIBAgIQN+o39s47b7xKGeApp7qR0DANBgkqhkiG9w0B
...
# CQQxFgQUg2+PF8pzPUdMtiaG/jPZnTz0C3YwDQYJKoZIhvcNAQEBBQAEggEAb9r+
# odzsySRGrqkzMhQpJHSkb5IqRhhzf5fxlqoVS7wZV3KXyXC7RWQk3zSAVAdeFu4l
# PmGHpV/6GloGYfg7ujIp2n3Kp8sFRnvTi25cyRIr8sqzhCaYNCBhnh73EJKl1YWw
# gjN8VLXOPGRBWbwTIUktCyX7NeG2NCBk/058E5B1AtKEz1D2cD1VyHkj8uV+JvEo
# VNGO+/kgHZrDn8481WnpEKKfbNUt1aY6WvlpDk9uCI71W+o+1Qchse/ZfyRmNpEv
# B657MxYt/BTybvGy0sRX4vgFqSiS9SvoMLDwoV+HXVuVamty4PXlfoycxYT82t1S
# ntBZ+V8fnbg2Sgm7/Q==
