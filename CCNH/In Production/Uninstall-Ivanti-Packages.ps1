...
Script Name: Uninstall-Ivanti-Packages.ps1
Author: Paul Hanlon for Catholic Charities NH
Created: 04/03/2025
Description: Uninstalls all Ivanti-related packages.
#>

Get-Package -name *Ivanti* | Uninstall-Package -Force

# SIG # Begin signature block
# MIIFeQYJKoZIhvcNAQcCoIIFajCCBWYCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUfz51Xtf72sSjAz7t8C3kc74b
# F6ugggMQMIIDDDCCAfSgAwIBAgIQN+o39s47b7xKGeApp7qR0DANBgkqhkiG9w0B
...
# CQQxFgQUfV9FA61S7Tf8YLSTS4hkdRZkms8wDQYJKoZIhvcNAQEBBQAEggEAj5+j
# OGxGoA0p/3Rkv3zATW0Su2XQ16js1X17zZt607Wrh+LH/uEVKALlxto5RVIyozkE
# KrfmFExZiZC3XUmpivOFXbwSfwVFNAWjwOhasOGXPvRIRrqgvnT3gMJxsYJM6jH0
# d29d9QT27SMK7dkiVz09aLEObEzS7SklW1fjWdo59I478KEb78EHPLrpkZsACAhu
# VRrEmt6SS2Y2W/2a590lMulLl6AUQKT+9zbcQjJ3BnlSioGXucyIQDgstYagXOT6
# IXSWL/H7TGa25eRqk/wdxsYFwqeDG6WZaVuUirPBkKkUGN3YV9HQK22oE1E6QNdb
# npqmr9nRebxZ4zgPrQ==
